...
object Stubs {
    ...
    val lines = listOf(
        Line("01", "Plg. Norte H. Virgen del Rocio", 0xffF54129, routes = routes),
        Line("02", "Puerta Triana - Heliopolis", 0xffF54129, routes = routes),
        Line("03", "Bellavista-S. Jeronimo-Pino Montano", 0xffF7A800, routes = routes),
        Line("05", "Puerta Triana - Santa Aurelia", 0xffF54129, routes = routes),
        Line("06", "Gta. S. Lázaro - Hosp. V. Rocio", 0xffF54129, routes = routes),
        Line("10", "Ponce de León - San Jerónimo", 0xff000D6F, routes = routes),
        Line("11", "Ponce de León - Los Principes", 0xff000D6F, routes = routes),
        Line("12", "Ponce de León -  Pino Montano", 0xff000D6F, routes = routes),
        Line("13", "Plaza Duque Pino Montano", 0xff000D6F, routes = routes),
        Line("14", "Plaza Duque - Poligono Norte - Las Golondrinas", 0xff000D6F, routes = routes),
        Line("15", "Ponce de León - San Diego", 0xff000D6F, routes = routes),
        Line("16", "Rialto - Valdezorras", 0xff000D6F, routes = routes),
        Line("20", "Ponce de León - Polígono de San Pablo", 0xff000D6F, routes = routes),
        Line("21", "Plaza de Armas - Polígono San Pablo", 0xff000D6F, routes = routes),
        Line("22", "Prado San Sebastian - Sevilla Este", 0xff000D6F, routes = routes),
        Line("24", "Ponce de León - Juan XXIII - Palmete", 0xff000D6F, routes = routes),
        Line("25", "Prado - Rochelambert", 0xff000D6F, routes = routes),
        Line("26", "Prado - Cerro del Aguila", 0xff000D6F, routes = routes),
        Line("27", "Plaza Duque - Sevilla Este", 0xff000D6F, routes = routes),
        Line("28", "Prado - Alcosa", 0xff000D6F, routes = routes),
        Line("29", "Prado S. Sebastian - Torreblanca", 0xff000D6F, routes = routes),
        Line("30", "Prado San Sebastián - La Paz", 0xff000D6F, routes = routes),
        Line("31", "Prado San Sebastián - Polígono Sur", 0xff000D6F, routes = routes),
        Line("32", "Plz. Duque - Plg. Sur", 0xff000D6F, routes = routes),
        Line("34", "Prado San Sebastián - Los Bermejales", 0xff000D6F, routes = routes),
        Line("37", "Pta. Jerez - Pedro Salvador - Bellavista", 0xff000D6F, routes = routes),
        Line("38A", "Prado - Pitamo - Olavide", 0xff000D6F, routes = routes),
        Line("39", "Los Arcos - Hac. S. Antonio", 0xff000D6F, routes = routes),
        Line("40", "Reyes Catolicos - Triana", 0xff000D6F, routes = routes),
        Line("41", "Reyes Catolicos - Tablada", 0xff000D6F, routes = routes),
        Line("43", "San Pablo - El Tardon", 0xff000D6F, routes = routes),
        Line("52", "S. Bernardo - Palmete", 0xff000D6F, routes = routes),
        Line("B3", "Gran Plaza - Santa Clara", 0xff84C6E3, routes = routes),
        Line("B4", "San Bernardo - Torreblanca", 0xff84C6E3, routes = routes),
        Line("C1", "Circular Exterior 1", 0xff008431, routes = routes),
        Line("C2", "Circular Exterior 2", 0xff008431, routes = routes),
        Line("C3", "Circular Interior 1", 0xff008431, routes = routes),
        Line("C4", "Circular Interior 2", 0xff008431, routes = routes),
        Line("C6A", "Circular Macarena Norte Sentido A", 0xff008431, routes = routes),
        Line("C6B", "Circular Macarena Norte Sentido B", 0xff008431, routes = routes),
        Line("CJ", "San Bernardo - Ciudad de La Justicia", 0xffF7A800, routes = routes),
        Line("EA", "Aeropuerto", 0xff84C6E3, routes = routes),
        Line("EC", "Lanzadera Charco La Pava", 0xff84C6E3, routes = routes),
        Line("LE", "Prado San Sebastián - Sevilla Este", 0xffF7A800, routes = routes),
        Line("LN", "Line Norte", 0xffF7A800, routes = routes),
        Line("LS", "Santa Justa - Bellavista", 0xffF7A800, routes = routes),
        Line("T1", "Metrocentro", 0xffC60018, routes = routes),
    )
    ...
    val stops = listOf(
        Stop(
            ...
            lines = lines.shuffled().take(Random.nextInt(1, 4)),
        ),
        Stop(
            code = 566,
